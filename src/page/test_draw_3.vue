...
export default {
  ...
  beforeMount(){
    if(localStorage.getItem('show3')){
      // let arr=localStorage.getItem('show3').split(",")
      this.show=[...(localStorage.getItem('show3').split(","))]
      //  console.log(arr)
    }
    if(localStorage.getItem("winners32")){
      this.winnerslist1 = JSON.parse(localStorage.getItem("winners31"));
      this.winnerslist2 = JSON.parse(localStorage.getItem("winners32"));
      // console.log(localStorage.getItem("show3"))
    }else{
      this.winnerslist1= [{id:"2",src:"static/img/2.jpg"},
        ...
        {id:"2",src:"static/img/2.jpg"},
        {id:"2",src:"static/img/2.jpg"}]
    localStorage.setItem("winners31", JSON.stringify(this.winnerslist1));
    this.winnerslist2= [{id:"2",src:"static/img/2.jpg"},
        {id:"2",src:"static/img/2.jpg"},
        {id:"2",src:"static/img/2.jpg"},
        {id:"2",src:"static/img/2.jpg"},
        {id:"2",src:"static/img/2.jpg"},
        ...
        {id:"2",src:"static/img/2.jpg"},
        {id:"2",src:"static/img/2.jpg"}]
    localStorage.setItem("winners32", JSON.stringify(this.winnerslist2));
    }
  ...
  methods:{
    ...
    fun2(a){
      ...
      this.timer=setTimeout(()=>{
        this.show.push(true)
        localStorage.setItem("show3",this.show)
...
#con>div:nth-child(2) {
  ...
  /* transition:all 0s 2000ms ease-out; */
}
