...
export default {
  ...
  beforeMount() {
    ...
    if(localStorage.getItem('show2')){
      this.show=[...(localStorage.getItem('show2').split(","))]
    }
    if (localStorage.getItem("winners22")) {
      this.winnerslist1 = JSON.parse(localStorage.getItem("winners21"));
      this.winnerslist2 = JSON.parse(localStorage.getItem("winners22"));
    } else {
      this.winnerslist1 = [
      ...
      localStorage.setItem("winners21", JSON.stringify(this.winnerslist1));
      this.winnerslist2 = [
        { id: "2", src: "static/img/2.jpg" },
        { id: "2", src: "static/img/2.jpg" },
        { id: "2", src: "static/img/2.jpg" },
      ...
      localStorage.setItem("winners22", JSON.stringify(this.winnerslist2));
    }
  ...
  methods: {
    ...
    fun1(a) {
      (this.data = this.data2), (this.winnerslist = this.winnerslist2);
    ...
    fun2(a) {
      ...
      this.timer = setTimeout(() => {
        this.show.push(true);
        localStorage.setItem("show2", this.show);
